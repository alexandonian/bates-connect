...
//        registerReceiver(receiver, callInterceptorIntentFilter);
    ...
    protected void onPause() {
        ...
        ParseQuery<ParseObject> query = ParseQuery.getQuery("Invite")
                .whereEqualTo("sender", UserList.user.getUsername())
                .whereEqualTo("receiver", buddy)
    ...
    private void inviteBuddy() {
        ...
        if (UserList.inviter) {
            ParseObject po = new ParseObject("Invite");
            po.put("sender", UserList.user.getUsername());
            po.put("receiver", buddy);
            po.put("pending", true);
//		ParseACL acl = new ParseACL();
//		acl.setReadAccess(buddy, true);
//		po.setACL(acl);
            po.saveEventually();
...
//        });
        ...
        // Send Chat Buddy Push Notification
        HashMap<String, Object> params = new HashMap<>();
        params.put("recipientUserName", buddy);
